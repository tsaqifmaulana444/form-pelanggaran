        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800" style="margin-top: 4%;">Data Poin Pelanggaran</h1>
                    ...
                    <div class="bungkus" style="width: auto; height:450px; overflow: auto; ">
                        <table class="table table-hover" style="margin-top: 5%;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href='editform2.php?id=".$value['id']."' style='color: #fff;'> <button type='button' class='btn btn-success'>Edit</button></a>
                                    <a href='delete2.php?id=".$value['id']."' style='color: #fff;'> <button type='button' class='btn btn-danger'>Delete</button></a>
                                </td>
                            </tr>";
                            $i++;
                        } 
