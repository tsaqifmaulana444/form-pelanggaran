...
include 'conn.php';
$id = $_GET['id'];
$sql = "SELECT * FROM pelanggaran WHERE id = '$id'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Edit Data Pelanggaran</h1>

                    <form action="edit2.php" method="post">
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label" style="display: none;">ID Pelanggaran</label>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="jenis" value="<?= $value['deskripsi']?>">
                        </div>
                        <div class="mb-3">
                            <label for="exampleInputEmail1" class="form-label">Poin</label>
                            <input type="number" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" name="poin" value="<?= $value['poin_pelanggaran']?>">
                        </div>                       
